        ...
        <div className="about-us-content">
          ...
          <div className="cards2">
            <div className="card2">
              ...
              <p>
                {" "}
                Condo Connect provides an easy-to-use and comprehensive platform
                that simplifies the condo management process for you!
              </p>
            </div>
            ...
            <div className="card2">
              ...
              <p>
                Simply enter the unique condo key provided to you by email and
                start building your condo empire!
              </p>
            </div>
            ...
            <div className="card2">
              ...
              <p>
                Leaky sink? No problem! Condo Connect&apos;s easy request system
                will help you submit any and all requests directly to the
                corresponding management companies account.
              </p>
            </div>
          </div>
        </div>
